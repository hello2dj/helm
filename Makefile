...
ifneq ($(BINARY_VERSION),)
	LDFLAGS += -X github.com/hello2dj/helm/v3/internal/version.version=${BINARY_VERSION}
endif
...
LDFLAGS += -X github.com/hello2dj/helm/v3/internal/version.metadata=${VERSION_METADATA}
LDFLAGS += -X github.com/hello2dj/helm/v3/internal/version.gitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/hello2dj/helm/v3/internal/version.gitTreeState=${GIT_DIRTY}
LDFLAGS += $(EXT_LDFLAGS)
...
LDFLAGS += -X github.com/hello2dj/helm/v3/pkg/lint/rules.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/hello2dj/helm/v3/pkg/lint/rules.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
LDFLAGS += -X github.com/hello2dj/helm/v3/pkg/chartutil.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/hello2dj/helm/v3/pkg/chartutil.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
